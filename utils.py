...
async def send_error_embed(ctx, title: str, description: str, delay: int = 5):
...
def build_command_help_embed(command_name: str) -> discord.Embed:
    ...
    if command_name == "addticket":
        ...
        embed.description = (
            ...
            "2. Обязательно укажите причину выдачи варна.\n\n"
            "**Использование:**\n"
            "`.warn [ID участника] [причина]`\n\n"
            "**Пример:**\n"
            "`.warn 851443344718430210 Нарушение правил чата.`"
        )
    elif command_name == "delwarn":
        embed.title = "Команда: delwarn"
        embed.description = (
            "Удалить предупреждение (варн) участника через интерактивное меню\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите ID участника, у которого нужно удалить варн.\n\n"
            "**Использование:**\n"
            "`.delwarn [ID участника]`\n\n"
            "**Пример:**\n"
            "`.delwarn 851443344718430210`"
        )
    elif command_name == "mute":
        embed.title = "Команда: mute"
        embed.description = (
            "Отправить участника в мьют (тайм-аут)\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите ID участника.\n"
            "2. Укажите длительность (например: `10m`, `2h`, `1d`).\n"
            "3. Обязательно укажите причину.\n\n"
            "**Использование:**\n"
            "`.mute [ID участника] [длительность] [причина]`\n\n"
            "**Пример:**\n"
            "`.mute 851443344718430210 1h Спам в каналах.`"
        )
    elif command_name == "unmute":
        embed.title = "Команда: unmute"
        embed.description = (
            "Досрочно снять мьют (тайм-аут) с участника\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите ID участника.\n"
            "2. Обязательно укажите причину снятия мьюта.\n\n"
            "**Использование:**\n"
            "`.unmute [ID участника] [причина]`\n\n"
            "**Пример:**\n"
            "`.unmute 851443344718430210 Ошибка выдачи.`"
        )
    elif command_name == "ban":
        embed.title = "Команда: ban"
        embed.description = (
            "Заблокировать участника на сервере навсегда\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите ID участника.\n"
            "2. Обязательно укажите причину бана.\n"
            "3. Указание длительности запрещено (баны выдаются навсегда).\n\n"
            "**Использование:**\n"
            "`.ban [ID участника] [причина]`\n\n"
            "**Пример:**\n"
            "`.ban 851443344718430210 Грубое нарушение правил.`"
        )
    elif command_name == "unban":
        embed.title = "Команда: unban"
        embed.description = (
            "Разблокировать ранее забаненного пользователя\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите ID пользователя.\n"
            "2. Укажите причину разбана (необязательно).\n\n"
            "**Использование:**\n"
            "`.unban [ID пользователя] [причина]`\n\n"
            "**Пример:**\n"
            "`.unban 851443344718430210 Апелляция принята`"
        )
    elif command_name == "modlogs":
        embed.title = "Команда: modlogs"
        embed.description = (
            "Просмотреть историю всех зафиксированных наказаний пользователя\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите упоминание или ID пользователя (необязательно).\n"
            "2. Если аргумент не указан, выводится ваша история.\n\n"
            "**Использование:**\n"
            "`.modlogs [упоминание / ID пользователя]`\n\n"
            "**Пример:**\n"
            "`.modlogs @Пользователь` или `.modlogs 851443344718430210`"
        )
    elif command_name == "modstats":
        embed.title = "Команда: modstats"
        embed.description = (
            "Просмотреть статистику выданных наказаний модератора\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите упоминание или ID модератора (необязательно).\n"
            "2. Если аргумент не указан, выводится ваша статистика.\n\n"
            "**Использование:**\n"
            "`.modstats [упоминание / ID модератора]`\n\n"
            "**Пример:**\n"
            "`.modstats @Пользователь` или `.modstats 851443344718430210`"
        )
    elif command_name == "moderations":
        embed.title = "Команда: moderations"
        embed.description = (
            "Просмотреть список всех наказаний, выданных конкретным модератором\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите упоминание или ID модератора (необязательно).\n"
            "2. Если аргумент не указан, выводятся выданные вами наказания.\n\n"
            "**Использование:**\n"
            "`.moderations [упоминание / ID модератора]`\n\n"
            "**Пример:**\n"
            "`.moderations @Пользователь` или `.moderations 851443344718430210`"
        )
    elif command_name == "delcase":
        embed.title = "Команда: delcase"
        embed.description = (
            "Удалить запись о деле из базы данных по его номеру\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите числовой номер (ID) дела.\n\n"
            "**Использование:**\n"
            "`.delcase [номер дела]`\n\n"
            "**Пример:**\n"
            "`.delcase 12`"
        )
    elif command_name == "addcase":
        embed.title = "Команда: addcase"
        embed.description = (
            "Импортировать запись о наказании по ID сообщения или ответу на сообщение\n\n"
            "**Правила аргументов:**\n"
            "1. Укажите ID сообщения с выданным наказанием или ответьте на него командой `.addcase`.\n\n"
            "**Использование:**\n"
            "`.addcase [ID сообщения]`\n\n"
            "**Пример:**\n"
