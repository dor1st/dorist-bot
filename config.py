    ...
    "roles": {
        ...
        "items": [
            ...
            },
            {
                ...
                "name": "Роль @1528428889703977171",
                "role_id": 1528428889703977171,
                "price": 5000,
                "description": "Даёт доступ к прикреплении фото и файлов в каналах.\nВыдаётся навсегда.\nВ наличии: 10"
            },
            {
                "id": "role_1528428801032327299",
                "name": "Роль @1528428801032327299",
                "role_id": 1528428801032327299,
                "price": 3000,
                "description": "Даёт доступ к прикреплении Embed к ссылкам и GIF в каналах.\nВыдаётся навсегда.\nВ наличии: 10"
            }
        ]
    },
}
