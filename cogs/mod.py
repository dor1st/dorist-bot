...
class ModCog(commands.Cog):
    ...
    async def build_mods_leaderboard_embed(self) -> discord.Embed:
        ...
        # 1. Варны
        embed.add_field(name="<:alert:1501500735316164710> Варны (7 дн.)", value=format_top(get_top_cases("Варн", d7)), inline=True)
        embed.add_field(name="<:alert:1501500735316164710> Варны (30 дн.)", value=format_top(get_top_cases("Варн", d30)), inline=True)
        embed.add_field(name="<:alert:1501500735316164710> Варны (Все время)", value=format_top(get_top_cases("Варн")), inline=True)
